...
export default function Page() {
  ...
  return (
    <section className="w-full min-h-screen">
      ...
      <HeroTitle>{t("professionalApproach.title")}</HeroTitle>
      {/* Content Section */}
      <div className="w-11/12 mx-auto flex items-center justify-center py-24 md:py-48">
        <div className="flex flex-col md:flex-row items-center gap-10 px-6 md:px-0">
          <div className="w-20 md:min-w-30 md:max-w-30">
            <Image src={mobileLogo} alt="mobileLogo" className="h-full object-contain"/>
          </div>
          <p className="text-paragraph text-lg md:text-[1.3rem] leading-relaxed">{t("professionalApproach.content")}</p>
        </div>
      </div>
    </section>
  )
